...
df_x = df[['EMP_PRSE', 'A_MEAN', 'MEAN_PRSE', 'A_PCT25', 'A_MEDIAN', 'A_PCT75', 'CPI', 'PRICE_INDEX', 'UNEMPLOYMENT_RATE', 'SP_INDEX']]
df[['EMP_PRSE', 'A_MEAN', 'MEAN_PRSE', 'A_PCT25', 'A_MEDIAN', 'A_PCT75', 'CPI', 'PRICE_INDEX', 'UNEMPLOYMENT_RATE', 'SP_INDEX']] = (df_x-df_x.mean())/df_x.std()
